...
class SubjectCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final averageStatus = GradeSummary.statusForAverage(average, passingGrade);
    final averageColor = switch (averageStatus) {
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                bottom: 0,
                width: 5,
                child: ColoredBox(color: effectiveAccentColor),
              ),
              Padding(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (workload != null ||
                              (absences != null && maxAbsences != null)) ...[
